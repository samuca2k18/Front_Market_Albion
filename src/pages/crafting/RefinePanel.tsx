              ...
              <div className="grid grid-cols-1 gap-2">
                {FAMILIES.map((row) => (
                  ...
                  >
                    ...
                    <span className="text-[10px] text-muted-foreground">{row.defaultCity}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {topQuery.data!.items.map((row) => (
                <button
                  ...
                  className="rounded-2xl border border-border/30 bg-background/40 p-4 text-left transition hover:border-amber-500/40 hover:bg-background/70"
                >
                  <div className="mb-3 flex items-start justify-between gap-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="font-mono text-[10px] text-muted-foreground">{row.item}</p>
                      </div>
                    </div>
